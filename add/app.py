...
# 如果需要匯入其他模組，例如 basic.helper 或 basic.config，可以在這裡加入
try:
    from basic.helper import greet
    from basic.config import DATABASE_URL
except ImportError:
    greet = lambda name: f"Hello, {name}! (default greet function)"
